...
import in.himanshu.moneymanager.util.JwtUtil;
...
public class ProfileService {
    ...
    public Map<String, Object> authenticateAndGenerateToken(AutoDTO autoDTO) {
        try {
            ...
            String token = jwtUtil.generateToken(autoDTO.getEmail());

            return Map.of(
                    "token", token,
                    "user", getPublicProfile(autoDTO.getEmail())
            );
